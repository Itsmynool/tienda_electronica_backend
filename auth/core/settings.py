...
CORS_ORIGIN_WHITELIST = env.list('CORS_ORIGIN_WHITELIST_DEV') #Permite la comunicacion entre microservicio con microservicio
CSRF_TRUSTED_ORIGINS = env.list('CSRF_TRUSTED_ORIGINS_DEV') #Permite la comunicacion entre fronted con backend
...
DATABASES = {
    'default': {
        ...
        'NAME': 'tiendaelectronica_auth_db',
        'USER': 'tiendaelectronica',
        'PASSWORD': 'postgres',
        'HOST': 'db',
        'PORT': '5432',
    }
...
if not DEBUG:
    ...
    DEFAULT_FROM_EMAIL = 'TiendaElectronica <noreply@tiendaelectronica.com>'
